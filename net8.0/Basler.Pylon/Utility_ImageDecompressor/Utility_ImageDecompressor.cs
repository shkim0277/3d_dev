                            ...
                            if (grabResult.GrabSucceeded)
                            {
                                ...
                                if (ImageDecompressor.GetCompressionInfo(ref compressionInfo, grabResult))
                                {
                                    ...
                                    if (compressionInfo.CompressionStatus == CompressionStatus.Ok)
                                    {
                                        ...
                                        {
                                            ImageWindow.DisplayImage(1, myBuffer, compressionInfo.PixelType, (int)compressionInfo.Width, (int)compressionInfo.Height, 0, ImageOrientation.TopDown);
                                        }
                                    }
                                    else
                                    {
                                ...
                                if (grabResult.GrabSucceeded)
                                {
                                    ...
                                    if (ImageDecompressor.GetCompressionInfo(ref compressionInfo, grabResult))
                                    {
                                        ...
                                        if (compressionInfo.CompressionStatus == CompressionStatus.Ok)
                                        {
                                            ...
                                            if (OperatingSystem.IsWindows())
                                            {
                                                ImageWindow.DisplayImage(2, myBuffer, compressionInfo.PixelType, (int)compressionInfo.Width, (int)compressionInfo.Height, 0, ImageOrientation.TopDown);
                                            }
                                        }
                                        else
                                        {
