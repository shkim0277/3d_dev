...
namespace ParameterizeCamera_AutoFunctions
{
    class ParameterizeCamera_AutoFunctions
    {
        ...
        static void Configure(Camera camera)
        {
            ...
            {
                regionSelector = (EnumName)PLCamera.AutoFunctionAOISelector;
            ...
            {
                regionSelector = (EnumName)PLCamera.AutoFunctionROISelector;
        ...
        static void AutoGainOnce(Camera camera)
        {
            ...
            {
                using (IGrabResult result = camera.StreamGrabber.GrabOne(5000, TimeoutHandling.ThrowException))
                {
                    ...
                    if (result.GrabSucceeded)
                    {
                        ...
                        {
                            ImageWindow.DisplayImage(0, result);
                        }
                    }
                }
                n++;
