...
namespace Grab_UsingBufferFactory
{
    ...
    class MyBufferFactory : IBufferFactory
    {
        ...
        public void AllocateBuffer(long bufferSize, out object createdPinnedObject, out IntPtr createdPinnedBuffer, out object bufferUserData)
        {
        ...
        public void FreeBuffer(object createdPinnedObject, IntPtr createdPinnedBuffer, object bufferUserData)
        {
            ...
            if (bufferUserData is not GCHandle)
            {
                return;
            }
